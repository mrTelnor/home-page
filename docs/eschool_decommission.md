...
сначала была оставлена, но в июне 2026 удалена миграцией
`007_drop_eschool_prs_id` — данных в ней не было (всё `NULL`).
Если интеграцию решат возродить, колонка восстанавливается
через `downgrade` миграции 007 или новой миграцией.
